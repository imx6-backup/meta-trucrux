...
SRCBRANCH = "trux-d01"
LOCALVERSION = "-2.0.1"
SRCREV = "01dde7a0b45117da4ad5e26587ba95b74a70f253" 
...
do_copy_defconfig () {
    if [ ${DO_CONFIG_V7_COPY} = "yes" ]; then
        ...
        mkdir -p ${B}
        cp ${S}/arch/arm/configs/trux_imx6uld01_defconfig ${B}/.config
        cp ${S}/arch/arm/configs/trux_imx6uld01_defconfig ${B}/../defconfig
    fi
}
